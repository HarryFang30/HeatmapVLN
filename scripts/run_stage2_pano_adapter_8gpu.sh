...
# Data
STAGE2_ADAPTER_NUM_WORKERS="${STAGE2_ADAPTER_NUM_WORKERS:-8}"
STAGE2_ADAPTER_PREFETCH_FACTOR="${STAGE2_ADAPTER_PREFETCH_FACTOR:-2}"
...
STAGE2_ADAPTER_MAX_BATCHES="${STAGE2_ADAPTER_MAX_BATCHES:-}"
