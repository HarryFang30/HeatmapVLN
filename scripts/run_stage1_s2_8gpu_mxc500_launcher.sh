...
export STAGE1_S2_BATCH_SIZE="${STAGE1_S2_BATCH_SIZE:-12}"
export STAGE1_S2_GRAD_ACCUM_STEPS="${STAGE1_S2_GRAD_ACCUM_STEPS:-1}"
export STAGE1_S2_NUM_WORKERS="${STAGE1_S2_NUM_WORKERS:-8}"
export STAGE1_S2_PREFETCH_FACTOR="${STAGE1_S2_PREFETCH_FACTOR:-2}"

# 沐曦上通常没有 NVIDIA FlashAttention2：关闭强制 FA，并改用 SDPA（若仍 OOM 再降 batch）
export STAGE1_S2_REQUIRE_FLASH_ATTN="${STAGE1_S2_REQUIRE_FLASH_ATTN:-0}"
export STAGE1_S2_LLM_ATTN_IMPLEMENTATION="${STAGE1_S2_LLM_ATTN_IMPLEMENTATION:-sdpa}"
