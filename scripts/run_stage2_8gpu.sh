...
STAGE2_LLM_ATTN_IMPLEMENTATION="${STAGE2_LLM_ATTN_IMPLEMENTATION:-}"
STAGE2_LLM_GRADIENT_CHECKPOINTING="${STAGE2_LLM_GRADIENT_CHECKPOINTING:-}"
STAGE2_HEATMAP_ENABLE="${STAGE2_HEATMAP_ENABLE:-}"
STAGE2_RANDOM_SUBSEQUENCE="${STAGE2_RANDOM_SUBSEQUENCE:-}"
STAGE2_ENABLE_TRAJECTORY_AUGMENTATION="${STAGE2_ENABLE_TRAJECTORY_AUGMENTATION:-}"
STAGE2_REQUIRE_FLASH_ATTN="${STAGE2_REQUIRE_FLASH_ATTN:-1}"
...
export STAGE2_LLM_ATTN_IMPLEMENTATION STAGE2_LLM_GRADIENT_CHECKPOINTING
export STAGE2_HEATMAP_ENABLE
export STAGE2_RANDOM_SUBSEQUENCE
export STAGE2_ENABLE_TRAJECTORY_AUGMENTATION
export HEATMAPVLN_REQUIRE_FLASH_ATTN="$STAGE2_REQUIRE_FLASH_ATTN"
