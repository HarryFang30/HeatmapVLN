...
export HEATMAP_DATA_ROOT="/mnt/afs/lixiaoou/intern/fjl/data/heatmap_randomwalk_train_v1"
...
export SINGLE_VIEW_HM_EXPERIMENT_ROOT="/mnt/afs/lixiaoou/intern/fjl/model/output_heatmap_internnav_single_view_v1_4gpu"
...
export SINGLE_VIEW_HM_INIT_CKPT="/mnt/afs/lixiaoou/intern/fjl/model/output_heatmap_internnav_single_view_v1/init/from_legacy_heatmap_53tensors_v2.pth"
