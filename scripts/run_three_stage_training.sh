...
# Cluster usage:
#   export INTERNNAV_MODEL_PATH=/path/to/full/InternNav_Model
...
STAGE2_NUM_WORKERS="${STAGE2_NUM_WORKERS:-6}"
STAGE2_PREFETCH_FACTOR="${STAGE2_PREFETCH_FACTOR:-4}"
...
export STAGE1_HM_FEISHU_NOTIFY STAGE1_HM_VALIDATION_ENABLED
