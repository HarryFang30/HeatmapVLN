...
# batch_size / grad_accum: defer to YAML config (no env-var default)
STAGE1_S2_BATCH_SIZE="${STAGE1_S2_BATCH_SIZE:-}"
STAGE1_S2_GRAD_ACCUM_STEPS="${STAGE1_S2_GRAD_ACCUM_STEPS:-}"
...
STAGE1_S2_NUM_HISTORY_SAMPLE="${STAGE1_S2_NUM_HISTORY_SAMPLE:-}"
STAGE1_S2_PANORAMIC_VLM_INPUT="${STAGE1_S2_PANORAMIC_VLM_INPUT:-}"
STAGE1_S2_LLM_ATTN_IMPLEMENTATION="${STAGE1_S2_LLM_ATTN_IMPLEMENTATION:-}"
STAGE1_S2_LLM_GRADIENT_CHECKPOINTING="${STAGE1_S2_LLM_GRADIENT_CHECKPOINTING:-}"
STAGE1_S2_REQUIRE_FLASH_ATTN="${STAGE1_S2_REQUIRE_FLASH_ATTN:-1}"
STAGE1_S2_MAX_CLIPS="${STAGE1_S2_MAX_CLIPS:-}"
...
export STAGE1_S2_NUM_HISTORY_SAMPLE STAGE1_S2_PANORAMIC_VLM_INPUT
export STAGE1_S2_LLM_ATTN_IMPLEMENTATION STAGE1_S2_LLM_GRADIENT_CHECKPOINTING
export STAGE1_S2_MAX_CLIPS
export HEATMAPVLN_REQUIRE_FLASH_ATTN="$STAGE1_S2_REQUIRE_FLASH_ATTN"
